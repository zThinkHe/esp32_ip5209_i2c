...
// 充电电流设置宏定义
#define IP5209_CHARGE_CURRENT_0_5A   5  // 500mA
#define IP5209_CHARGE_CURRENT_0_8A   8  // 800mA
#define IP5209_CHARGE_CURRENT_1A     10 // 1A
#define IP5209_CHARGE_CURRENT_1_2A   12 // 1.2A
#define IP5209_CHARGE_CURRENT_1_5A   15 // 1.5A
#define IP5209_CHARGE_CURRENT_2A     20 // 2A
#define IP5209_CHARGE_CURRENT_2_3A   23 // 2.3A
